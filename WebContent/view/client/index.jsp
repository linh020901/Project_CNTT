          ...
          <div class="aa-testimonial-area">
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="${url}/images/linh.png" alt="avatar 1">
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/tuyen.png" alt="avatar 2">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/tu.png" alt="avatar 3">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
