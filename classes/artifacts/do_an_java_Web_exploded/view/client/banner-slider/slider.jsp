      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/28-1200x676.jpg" alt="Men slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/veget1.png" alt="Wristwatch slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/fruits.png" alt="Women Jeans slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/honey.png" alt="Shoes slide img" />
              </div>
              <div class="seq-title">
