      ...
      <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
          <a href="${pageContext.request.contextPath}/admin/order/list-detail">
            <i class="zmdi zmdi-file-text"></i> <span>Chi Tiết Đơn Hàng</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="${pageContext.request.contextPath}/admin/new/list">
            <i class="zmdi zmdi-email-open"></i> <span>Tin tức</span>
          </a>
        </li>
        <li>
          <a href="${pageContext.request.contextPath}/">
            <i class="zmdi zmdi-pin"></i> <span>Trở về trang chủ</span>
          </a>
        </li>
      </ul>
    </div>